...
function BoxSkeleton({ className = '' }: { className?: string }) {
  return <div className={`animate-pulse bg-theme-color rounded-md ${className}`} />;
}
                ...
                <div
                  ...
                  style={
                    isStar
                      ? {
                          backgroundColor:
                            'color-mix(in srgb, var(--color-destructive) 20%, var(--color-card))',
              ...
              {isAuthenticated && (
                <Tooltip content={isFavorite ? t('unfavorite') : t('favorite')}>
                  ...
                  >
                    ...
                    <p className="m-0 text-[10px] md:text-xs font-medium">
          ...
          <div className="content">
            ...
            {(detail?.tags?.length ?? 0) > 0 && (
              <div className="tags mb-6">
                <span className="text-theme-muted-foreground font-medium mr-2">
                  {t('tags_label')}
                </span>
            ...
            {detail.authorName && (
              <div className="author mb-6 flex items-center text-theme-muted-foreground">
                ...
                <a
                  ...
                  className="text-theme-primary hover:opacity-80 transition-opacity font-medium"
                >
                  {detail.authorName}
                </a>
              </div>
                    ...
                    <Col span={12} sm={8} md={6} key={item.id}>
                      ...
                      >
                        <DoggyImage
                          logo={item.logo}
                          name={item.name}
                          className="nav-logo w-6 h-6 mr-3 rounded"
                          width={24}
                          height={24}
                        />
