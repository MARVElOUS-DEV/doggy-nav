...
export default function Affiche() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-lg p-3 text-sm relative overflow-hidden shadow-sm">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between min-h-[40px] gap-2">
        <div className="flex items-center flex-1 w-full min-h-[24px]">
          <div className="flex items-center w-full">
            ...
            {currentAnnouncement.link && (
              <Link
                className="text-blue-600 hover:text-blue-800 font-medium hover:underline whitespace-nowrap ml-1"
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto justify-between sm:justify-end">
          <div className="flex items-center space-x-1">
            ...
            {announcements.length > 1 && (
              <>
                <button
                  onClick={goToPrev}
                  className="text-gray-500 hover:text-gray-700 p-1 rounded-full hover:bg-gray-100 transition-colors sm:hidden"
          ...
          {/* Close button */}
          <ArcoLink
            icon={<IconCloseCircle className="text-gray-500 hover:text-gray-700 ml-1"/>}
