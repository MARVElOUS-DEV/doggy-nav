export default [
  ...
  {name: '用户管理', icon: 'user', path: '/user/manage', component: './user', access: 'isSysadmin'},
  {name: '分组管理', icon: 'team', path: '/group/manage', component: './group', access: 'isSysadmin'},
  {name: '角色管理', icon: 'crown', path: '/role/manage', component: './role', access: 'isSysadmin'},
  {name: '邀请码', icon: 'key', path: '/user/invite', component: './user/invite'},
  {name: '应用管理', icon: 'api', path: '/client/manage', component: './client', access: 'isSysadmin'},
