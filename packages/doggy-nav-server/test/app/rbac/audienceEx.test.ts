...
import { buildAudienceFilterEx } from '../../../app/utils/audience';

const base = { status: 0 };

describe('audience - viewer open-only mode', () => {
  it('viewer in main limits to open/public-only', () => {
    const filter: any = buildAudienceFilterEx(base, {
      roles: ['viewer'],
